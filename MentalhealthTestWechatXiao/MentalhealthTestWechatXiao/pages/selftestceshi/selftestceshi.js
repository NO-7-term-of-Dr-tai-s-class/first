...
Page({
  ...
  radioChange(e) {
    ...
    this.data.endtotal = parseInt(this.data.endtotal) + parseInt(e.detail.value);
  ...
  commitselftestbtn(){
    ...
    var that = this;
    wx.request({
      url: config.host + 'MentalhealthTestWechatWeb/AddSelftestScoreInfoForXiao',
      method: 'post',
      data: {
      ...
      success: function (res) {
        ...
        wx.navigateTo({
          url: '/pages/ziwoceshiresults/ziwoceshiresults'
        })
  ...
  requestData(sindex) {
    var that = this;
    wx.request({
      url: config.host + 'MentalhealthTestWechatWeb/GetSindexSelftestInfoForXiao',
      method: 'post',
      data: {
        sindex: sindex
      },
