...
<div class="modal fade" id= "upVUserInfoModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
					...
					<div class="panel-body">
						...
						<div class="form-group">		
							<label class="col-sm-2 control-label">姓名:</label>
							   	<input type="text" class="col-sm-9" id="uaUserName" placeholder="请输入姓名">
						</div>
